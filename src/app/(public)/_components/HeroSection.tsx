      ...
      <div className="w-[1400px] h-[680px] mx-auto mt-[60px] relative overflow-hidden rounded-3xl">
        ...
        <div className="absolute left-[82px] top-[57px] w-[561px] flex flex-col gap-10 z-10">
          ...
          <div className="flex items-center gap-5">
            <Link
              href="/register"
              className="px-5 py-2.5 bg-[linear-gradient(270deg,#79B669_0%,#1F8505_100%)] overflow-hidden rounded-xl text-white text-base font-medium no-underline"
            >
              Register Now
            </Link>
            <Link
              href="#contact"
              className="px-5 py-2.5 overflow-hidden rounded-xl border border-[#1F8505] text-[#1F8505] text-base font-medium no-underline"
            >
              Contact Us
            </Link>
          </div>
