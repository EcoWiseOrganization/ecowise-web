        ...
        <div style={{ width: 387, display: "inline-flex", flexDirection: "column", gap: 46 }}>
          ...
          <form action={login} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <label
                htmlFor="email"
                style={{ color: "#141514", fontSize: 14, fontFamily: "Inter", fontWeight: 500 }}
              >
                Email / Phone Number
              </label>
              <input
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Link
                  href="#"
                  style={{ color: "#6E726E", fontSize: 10, fontFamily: "Inter", fontWeight: 500, textDecoration: "none" }}
                >
                  Forgot password
                </Link>
              </div>
